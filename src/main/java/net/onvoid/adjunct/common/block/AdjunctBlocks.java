...
public class AdjunctBlocks {
    ...
    public static final RegistryObject<Block> PINEAPPLE_UPSIDE_DOWN_CAKE = BLOCKS.register("pineapple_upside_down_cake", () -> new CakeBlock(AbstractBlock.Properties.copy(Blocks.CAKE)));
